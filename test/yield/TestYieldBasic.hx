...
class TestYieldBasic extends BaseCase implements IAsyncable {
	...
	@:yield function basicYieldReturn():Iterable<Int> {
		dummy += '1';
		@:yield return 10;
		dummy += '2';
		@:yield return 20;
	...
	@:yield function basicYieldReturn_multipleIterations():Iterable<Int> {
		dummy += '1';
		@:yield return 10;
		dummy += '2';
		@:yield return 20;
	...
	@:yield function localFunction() {
		inline function local1() return 20;
		function local2() {
			return 30;
		}
		@:yield return 10;
	...
	@:yield function descendantsOfParent():Iterable<Parent> {
